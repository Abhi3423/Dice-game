...
function Landing() {
    ...
    return (
        <div className='flex items-center justify-center' style={{ "height": "100vh" }} id="land">
            ...
            {isOpenPlayer && (
                <div id="openplayers" className='text-xl text-black font-bold border-4 border-white rounded-lg items-center justify-center bg-white'>
                    <h1 className='ml-8 mt-4'> ENTER NUMBER OF PLAYERS </h1>
                    <br></br>
                    <form className='ml-16' id="form2" onSubmit={submitp}>
                        <label>
                            <input id="players" className='border-2 border-gray-300 border-solid w-8/12 mt-2 indent-2' style={{ "height": "4vh" }} type="number" autoComplete="off" min="2" required />
                        </label>
                        <br></br>
                        <br></br><br></br>
